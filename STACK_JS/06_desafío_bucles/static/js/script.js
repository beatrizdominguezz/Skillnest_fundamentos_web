...
//  de veces que un usuario interactúa con un botón. Escribe un programa que imprima los números
//  del 1 al 10 para simular las interacciones de un usuario. Ejemplo de salida esperada:
...
//  un descuento progresivo en una promoción especial. El primer producto tiene un 5% de descuento,
//  el segundo un 10%, el tercero un 15%, y así sucesivamente hasta el quinto producto con un 25%.
...
// 🎮 Calcular el total de puntos en un videojuego: Un jugador gana 50 puntos cada vez que completa
//  un nivel. Escribe un programa que calcule la puntuación total después de 5 niveles usando un bucle.
//  Ejemplo de salida esperada:
